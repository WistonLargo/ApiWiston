...
public class MovilRepositoryTest {
	...
	public void testFindTop5ByOrderByNumeroDeVisitasDesc() {
		...
		Dimensiones dimensiones = new Dimensiones(150.0, 70.0, 8.0);
		...
		//vemos que solo hay 5 resultados
		assertEquals(5, top5Moviles.size());

		//verifica que los resultados están en orden descendente por número de visitas
