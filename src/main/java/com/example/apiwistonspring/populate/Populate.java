...
public class Populate {
	...
	public Populate(DimensionesRepository dimensionesRepository, MarcaRepository marcaRepository,
			...
			AnuncioRepository anuncioRepository, UserRepository userRepository, RoleRepository roleRepository) {
		super();
	...
	public void populate() {
		...
		Anuncio anuncio1 = new Anuncio(movil1, usuario, EstadoTelefono.experimentado, TipoCambio.venta, true);
		anuncioRepository.save(anuncio1);
		Anuncio anuncio2 = new Anuncio(movil2, usuario, EstadoTelefono.heroedeguerra, TipoCambio.venta, false);
		anuncioRepository.save(anuncio2);
		Anuncio anuncio3 = new Anuncio(movil3, usuario, EstadoTelefono.superviviente, TipoCambio.intercambio, false);
		anuncioRepository.save(anuncio3);
		Anuncio anuncio4 = new Anuncio(movil4, usuario, EstadoTelefono.intacto, TipoCambio.intercambio, true);
